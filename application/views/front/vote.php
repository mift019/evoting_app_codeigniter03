            ...
            <?php foreach ($kandidat_data as $kandidat) : ?>
                <div class="col-md-<?php echo $bootstrapColWidth; ?>">
                    <div style="margin-top: 60px; 
                        ...
                        <img class="card-img-top" style="object-fit:fill; background: #ffffff; border-radius: 15px 15px 0px 0px;" height="240px" src="<?php echo base_url('assets/uploads/kandidat/') . $kandidat->foto ?>" alt="Card image cap">
